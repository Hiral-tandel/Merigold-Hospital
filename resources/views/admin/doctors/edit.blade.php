    ...
    <div class="container">
        ...
        <form action="{{ route('admin.doctors.update', $doctor->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="education" name="education" required>{{ old('education', $doctor->education) }}</textarea>
            </div>

            <div class="form-group">
                <label for="experience">Experience</label>
                <textarea id="experience" name="experience" required>{{ old('experience', $doctor->experience) }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                @if($doctor->photo)
                    <div class="current-photo">
                        <img src="{{ Storage::url($doctor->photo) }}" alt="{{ $doctor->name }}" class="preview-image">
                        <p>Current photo</p>
                    </div>
                @endif
            ...
            <div class="form-group">
                ...
                <textarea id="about" name="about">{{ old('about', $doctor->about) }}</textarea>
            </div>
